...
$(document).ready(function() {
	...
	new AjaxUpload('package_file', {
	       action: 'upload/package/1',
			...
			onComplete : function(file, response){
			 ...
			 /* 	var path_file='getFileAttached("getfile/template/${seriesForm.missSery.msId}/'+obj.hotlink+'")'; */
				//$('#package_file_attached').attr('onclick',path_file);
				//$('#package_file_attached').html(file);
				//$('#package_file_attached').attr('style','cursor: pointer;');	
			}		
		});
});
function goPrev(){
...
function doAction(mode,id){
	...
	$.post("breakdown/search",$("#packageImportForm").serialize(), function(data) {
		  // alert(data);
		    appendContent(data);
		  // alert($("#_content").html());
		});
...
<fieldset style="font-family: sans-serif;padding-top:36px">
           ...
           <!-- <div style="position:relative;right:-94%;">  </div> --> 
            ...
            <form:form id="packageImportForm" name="packageImportForm" modelAttribute="packageImportForm"  cssClass="well" cssStyle="border:2px solid #B3D2EE;background: #F9F9F9" action="" method="post">
          <%--   <form:hidden path="mode"/>
            ...
            <div align="center" style="padding: 10px 60px">
            	...
            	<a class="btn" id="package_file"><i class="icon-file"></i>&nbsp;<span style="">Upload Package</span></a> 
            	</span>  
